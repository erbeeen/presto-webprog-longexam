  ...
  return (
    <section className="min-h-screen bg-zinc-100 text-zinc-900">
      <div className="grid min-h-screen w-full lg:grid-cols-[1fr_0.95fr]">
        <div className="flex items-center justify-center border-b-2 border-zinc-300 bg-primary p-8 sm:p-10 lg:border-b-0 lg:border-r-2 lg:border-zinc-300 lg:p-16">
          ...
          {/*   </div> */}
          {/* </div> */}
          <div className='p-16 flex items-center justify-center border-2 border-secondary rounded-full bg-secondary'>
            <img src={logo} alt="NU Banner" />
          </div>
        </div>
